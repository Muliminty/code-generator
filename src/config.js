module.exports = {
    ...
    templatesService: [
        ...
        },
        {
            ...
            'targetPath': `/output/template/service/vo/request`, // 生成路径
        ...
        },
        {
            ...
            "outSuffix": ".java", // 生成文件后缀
            "outPath": "/src/template/service/vo", // 模板路径
            'targetPath': `/output/template/service/vo/response`, // 生成路径
        },
        {
        ...
        {
            "templateName": "permission.txt", // 读取的模板文件名
            "fileName": "permission", // 生成文件名
            "outSuffix": ".json", // 生成文件后缀
            "outPath": "/src/template/service", // 模板路径
            'targetPath': `/output/template/service`, // 生成路径
        },
    ]
